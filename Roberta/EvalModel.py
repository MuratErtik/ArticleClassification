...
training_losses = [0.3919, 0.2189, 0.1611, 0.1248, 0.1024]  
validation_losses = [0.2405, 0.2361, 0.2308, 0.2343, 0.2238]  
...
labels = tokenizer.convert_ids_to_tokens(list(range(model.config.num_labels)))  
